...
window.rangy = (function () {
	...
	function h() {
		if (!q.initialized) {
			var a,
				d = !1,
				g = !1;
			b(document, "createRange") && ((a = document.createRange()), p(a, n) && t(a, m) && (d = !0), a.detach());
			if (
				(a = c(document, "body") ? document.body : document.getElementsByTagName("body")[0]) &&
				b(a, "createTextRange")
			)
				(a = a.createTextRange()), e(a) && (g = !0);
			!d && !g && f("Neither Range nor TextRange are implemented");
			q.initialized = !0;
			q.features = { implementsDomRange: d, implementsTextRange: g };
			d = A.concat(y);
			g = 0;
	...
	q.warn = function (a) {
		...
		q.config.alertOnWarn
			? window.alert(a)
			: typeof window.console != k && typeof window.console.log != k && window.console.log(a);
	};
	({}).hasOwnProperty
	...
	if (typeof window == k) f("No window found");
		...
		return (
			b(document, "addEventListener") && document.addEventListener("DOMContentLoaded", r, !1),
...
rangy.createModule("DomUtil", function (b, c) {
	...
	var n = "undefined",
		v = b.util;
	v.areHostMethods(document, ["createDocumentFragment", "createElement", "createTextNode"]) ||
	...
	v.areHostMethods(u, ["splitText", "deleteData", "insertData", "appendData", "cloneNode"]) ||
...
rangy.createModule("DomRange", function (b) {
	...
	function d(a, b, c) {
		if ((b = a._listeners[b])) for (var d = 0, e = b.length; d < e; ++d) b[d].call(a, { target: a, args: c });
	}
	function e(a) {
	...
	function k(b) {
		for (var c, d = a(b.range).createDocumentFragment(), e; (c = b.next()); ) {
			b.isPartiallySelectedSubtree()
				? ((c = c.cloneNode(!1)), (e = b.getSubtreeIterator()), c.appendChild(k(e)), e.detach(!0))
				: b.remove();
	...
	function x(a) {
		q(a);
		if (
			(!l.arrayContains(M, a.startContainer.nodeType) && !I(a.startContainer, !0)) ||
			(!l.arrayContains(M, a.endContainer.nodeType) && !I(a.endContainer, !0)) ||
			!(
				a.startOffset <=
				(l.isCharacterDataNode(a.startContainer) ? a.startContainer.length : a.startContainer.childNodes.length)
			) ||
			!(
				a.endOffset <=
				(l.isCharacterDataNode(a.endContainer) ? a.endContainer.length : a.endContainer.childNodes.length)
			)
		)
		...
		b.util.extend(a.prototype, {
			...
			splitBoundaries: function () {
				...
				l.isCharacterDataNode(a) &&
					...
					g ? ((e -= b), (c = a)) : c == a.parentNode && e >= l.getNodeIndex(a) && e++,
					(b = 0));
				d(this, a, b, c, e);
			},
				...
				var a = this.startContainer,
					...
					g = function (a) {
						...
						b &&
							...
							((c = a), (e = a.length), a.appendData(b.data), b.parentNode.removeChild(b));
					},
					j = function (d) {
						...
						if (g && g.nodeType == d.nodeType) {
							...
							a == c
								? ((e += b), (c = a))
								: c == d.parentNode && ((g = l.getNodeIndex(d)), e == g ? ((c = d), (e = j)) : e > g && e--);
						}
					},
					f = !0;
				l.isCharacterDataNode(c)
					? c.length == e && g(c)
					: (0 < e && (f = c.childNodes[e - 1]) && l.isCharacterDataNode(f) && g(f), (f = !this.collapsed));
				f
					? l.isCharacterDataNode(a)
						? 0 == b && j(a)
						: b < a.childNodes.length && (g = a.childNodes[b]) && l.isCharacterDataNode(g) && j(g)
					: ((a = c), (b = e));
				d(this, a, b, c, e);
			},
			collapseToPoint: function (a, b) {
				...
				t(a, !0);
				A(a, b);
				(a !== this.startContainer || b !== this.startOffset || a !== this.endContainer || b !== this.endOffset) &&
					d(this, a, b, a, b);
			},
		});
		s(a);
	...
	function O(a, b, c, e, g) {
		...
		a.endOffset = g;
		R(a);
		d(a, "boundarychange", { startMoved: j, endMoved: f });
	}
	function w(a) {
	...
	G.prototype = {
		...
		createContextualFragment: W
			? function (a) {
					...
					d =
						null === d ||
						("HTML" == d.nodeName && l.isHtmlNamespace(l.getDocument(d).documentElement) && l.isHtmlNamespace(d))
		...
		union: function (a) {
			if (this.intersectsRange(a, !0)) {
				...
				-1 == l.comparePoints(a.startContainer, a.startOffset, this.startContainer, this.startOffset) &&
					b.setStart(a.startContainer, a.startOffset);
				1 == l.comparePoints(a.endContainer, a.endOffset, this.endContainer, this.endOffset) &&
		...
		containsNodeText: function (a) {
			...
			var c = b.getNodes([3]);
			return 0 < c.length
				? (b.setStart(c[0], 0), (a = c.pop()), b.setEnd(a, a.length), (a = this.containsRange(b)), b.detach(), a)
...
rangy.createModule("WrappedRange", function (b) {
	function c(a, b, c, d) {
		...
		do j.insertBefore(b, b.previousSibling), g.moveToElementText(b);
		...
		if (-1 == h && k && e.isCharacterDataNode(k)) {
			...
			if (/[\r\n]/.test(k.data)) {
				j = g.duplicate();
				c = j.text.replace(/\r\n/g, "\r").length;
				for (c = j.moveStart("character", c); -1 == j.compareEndPoints("StartToEnd", j); )
					c++, j.moveStart("character", 1);
			} else c = g.text.length;
			j = new f(k, c);
		} else
			(k = (d || !c) && b.previousSibling),
				(j =
					(c = (d || c) && b.nextSibling) && e.isCharacterDataNode(c)
						? new f(c, 0)
						: k && e.isCharacterDataNode(k)
							? new f(k, k.length)
							: new f(j, e.getNodeIndex(b)));
	...
	if (b.features.implementsDomRange && (!b.features.implementsTextRange || !b.config.preferTextRange)) {
		...
		g.selectNodeContents =
			n.startContainer == m && n.endContainer == m && 0 == n.startOffset && n.endOffset == m.length
				? function (a) {
		...
		g.compareBoundaryPoints =
			(-1 == n.compareBoundaryPoints(n.START_TO_END, k)) & (1 == n.compareBoundaryPoints(n.END_TO_START, k))
				? function (a, b) {
						b = b.nativeRange || b;
		...
		b.util.isHostMethod(n, "createContextualFragment") &&
			(g.createContextualFragment = function (a) {
	...
	b.addCreateMissingNativeApiListener(function (a) {
		a = a.document;
		"undefined" == typeof a.createRange &&
...
rangy.createModule("WrappedSelection", function (b, c) {
	...
	function h(a) {
		...
		a instanceof t
			? ((c = a._selectionNativeRange),
				c ||
					((c = b.createNativeRange(p.getDocument(a.startContainer))),
			...
			: a instanceof q
				? (c = a.nativeRange)
				: b.features.implementsDomRange && a instanceof p.getWindow(a.startContainer).Range && (c = a);
		return c;
	}
	function i(a) {
		var b = a.getNodes(),
	...
	function j(a) {
		...
		if ("None" == a.docSelection.type) f(a);
			...
			if (c && "undefined" != typeof c.text) g(a, c);
				...
				for (var d, j = p.getDocument(c.item(0)), h = 0; h < a.rangeCount; ++h)
					(d = b.createRange(j)), d.selectNode(c.item(h)), a._ranges.push(d);
	...
	function k(a, b) {
		for (
			var c = a.docSelection.createRange(),
				d = i(b),
				e = p.getDocument(c.item(0)),
				e = p.getBody(e).createControlRange(),
				g = 0,
				f = c.length;
			g < f;
			++g
	...
	function n(a, b) {
		for (
			var c = p.getDocument(b[0].startContainer), c = p.getBody(c).createControlRange(), d = 0, e;
			d < rangeCount;
			++d
		) {
			e = i(b[d]);
	...
	var p = b.dom,
		...
		B,
		D,
		z = b.util.isHostMethod(window, "getSelection"),
	...
	var O = !1,
		w = !0;
	if (
		r.areHostMethods(z, ["addRange", "getRangeAt", "removeAllRanges"]) &&
		"number" == typeof z.rangeCount &&
	...
	var F = !1;
	s &&
		r.isHostMethod(s, "createControlRange") &&
		((s = s.createControlRange()), r.areHostProperties(s, ["item", "add"]) && (F = !0));
		...
		: J &&
			(P = function (a) {
				...
				c.collapsed !== this.isCollapsed &&
					(c.setStart(a.focusNode, a.focusOffset), c.setEnd(a.anchorNode, a.anchorOffset));
				return c;
			});
		...
		s.addRange = R
			? function (a, c) {
					if (F && x && "Control" == this.docSelection.type) k(this, a);
						...
						this.rangeCount == d + 1
							? (b.config.checkSelectionRanges &&
									(d = P(this.nativeSelection, this.rangeCount - 1)) &&
									!t.rangesEqual(d, a) &&
									(a = new q(d)),
								(this._ranges[this.rangeCount - 1] = a),
								e(this, a, L(this.nativeSelection)),
								(this.isCollapsed = D(this)))
							: this.refresh();
					}
				}
			: function (a, b) {
	...
	if (G)
		I = function (a) {
			var c;
			b.isSelectionValid(a.win)
				? (c = a.docSelection.createRange())
				: ((c = p.getBody(a.win.document).createTextRange()), c.collapse(!0));
		...
		? function (a) {
				if ("Control" == this.docSelection.type) {
					for (
						var b = this.docSelection.createRange(),
							a = i(a),
							c = p.getDocument(b.item(0)),
							c = p.getBody(c).createControlRange(),
							d,
							e = !1,
							g = 0,
							f = b.length;
						...
						(d = b.item(g)), d !== a || e ? c.add(b.item(g)) : (e = !0);
					c.select();
					j(this);
				} else T(this, a);
			}
	...
	s.toHtml = function () {
		...
		if (this.rangeCount) {
			for (
				var a = t.getRangeDocument(this._ranges[0]).createElement("div"), b = 0, c = this._ranges.length;
				b < c;
				++b
			)
...
wysihtml5.browser = (function () {
	var b = navigator.userAgent,
		...
		h = -1 !== b.indexOf("Opera/"),
		i = { formatBlock: a, insertUnorderedList: a || e, insertOrderedList: a || e },
		g = { insertHTML: d };
	return {
		USER_AGENT: b,
		supported: function () {
			var a = this.USER_AGENT.toLowerCase(),
				...
				a =
					(this.isIos() &&
						5 > +((/ipad|iphone|ipod/.test(a) && a.match(/ os (\d+).+? like mac os x/)) || [, 0])[1]) ||
					(this.isAndroid() && 4 > +(a.match(/android (\d+)/) || [, 0])[1]) ||
...
wysihtml5.dom.convertToList = (function () {
	...
	return function (c, a) {
		...
		for (m = 0; m < h; m++)
			(k = k || b(d, e)),
				(i = f[m]),
				(g = "block" === wysihtml5.dom.getStyle("display").from(i)),
				(j = "BR" === i.nodeName),
				g
					? ((k = k.firstChild ? b(d, e) : k), k.appendChild(i), (k = null))
					: j
						? (k = k.firstChild ? null : k)
						: k.appendChild(i);
		0 === f.length && b(d, e);
			...
			from: function (d) {
				if (d.nodeType === wysihtml5.ELEMENT_NODE) {
					...
					if (f.getComputedStyle)
						return (
							e && ((k = h.overflow), (h.overflow = "hidden")),
							(d = f.getComputedStyle(d, null).getPropertyValue(a)),
							e && (h.overflow = k || ""),
							d
						);
				}
	...
	return {
		stop: function () {
			for (var e, g = 0, f = c.length; g < f; g++)
				(e = c[g]), b.removeEventListener ? b.removeEventListener(e, a, !1) : b.detachEvent("on" + e, d);
		},
	};
};
wysihtml5.dom.parse = (function () {
	...
	var a = {
			1: function (a) {
				...
				j.src &&
					("undefined" !== typeof j.width && g.setAttribute("width", j.width),
					"undefined" !== typeof j.height && g.setAttribute("height", j.height));
				return g;
			},
			3: function (a) {
		...
		u = { left: "wysiwyg-float-left", right: "wysiwyg-float-right" },
		p = {
	...
	return function (a, c, d, e) {
		...
		for (
			var d = d || a.ownerDocument || document,
				...
				g = "string" === typeof a,
				a = g ? wysihtml5.dom.getAsDom(a, d) : a;
			a.firstChild;
			...
			if (d)
				for (h && "block" !== b.getStyle("display").from(h) && c(f); (g = a.firstElementChild || a.firstChild); ) {
					for (e = g.lastChild; (h = g.firstChild); )
						(i = (i = h === e) && "block" !== b.getStyle("display").from(h) && "BR" !== h.nodeName),
							f.appendChild(h),
							i && c(f);
					g.parentNode.removeChild(g);
				}
...
(function (b) {
	b.simulatePlaceholder = function (c, a, d) {
		...
		c.on("set_placeholder", f)
			.on("unset_placeholder", e)
			.on("focus:composer", e)
			.on("paste:composer", e)
			.on("blur:composer", f);
		f();
			...
			if (g) {
				...
				(g = this.doc.querySelector("._wysihtml5-temp-placeholder"))
					? ((i = rangy.createRange(this.doc)),
						(j = g.nextSibling),
						b.browser.hasInsertNodeIssue() && j && "BR" === j.nodeName
							? ((j = this.doc.createTextNode(b.INVISIBLE_SPACE)),
								c.insert(j).after(g),
								i.setStartBefore(j),
								i.setEndBefore(j))
							: (i.selectNode(g), i.deleteContents()),
						this.setSelection(i))
					: e.focus();
	...
	f.prototype = {
		getAncestorWithClass: function (a) {
			for (var d; a; ) {
				...
				if (a.nodeType == b.ELEMENT_NODE && c.dom.arrayContains(this.tagNames, a.tagName.toLowerCase()) && d)
					return a;
				a = a.parentNode;
			}
			return !1;
		...
		postApply: function (a, b) {
			for (
				var c = a[0], d = a[a.length - 1], f = [], h, i = c, p = d, r = 0, t = d.length, q, y, A = 0, B = a.length;
				A < B;
				++A
			)
				(q = a[A]),
					(y = this.getAdjacentMergeableTextNode(q.parentNode, !1))
						? (h || ((h = new e(y)), f.push(h)),
							h.textNodes.push(q),
							q === c && ((i = h.firstTextNode), (r = i.length)),
							q === d && ((p = h.firstTextNode), (t = h.getLength())))
						: (h = null);
						...
						a: if (a.attributes.length != b.attributes.length) d = !1;
							...
							for (var e = a.attributes.length, f, h; d < e; ++d)
								if (
									...
									(h = f.name),
									"class" != h &&
										((h = b.attributes.getNamedItem(h)),
										f.specified != h.specified || (f.specified && f.nodeValue !== h.nodeValue)))
								) {
									d = !1;
									break a;
								}
		...
		applyToTextNode: function (a) {
			var b = a.parentNode;
			1 == b.childNodes.length && c.dom.arrayContains(this.tagNames, b.tagName.toLowerCase())
				? this.cssClass &&
					((a = this.cssClass),
					b.className
						? (b.className && (b.className = b.className.replace(this.similarClassRegExp, "")),
							(b.className += " " + a))
						: (b.className = a))
				: ((b = this.createContainer(c.dom.getDocument(a))), a.parentNode.insertBefore(b, a), b.appendChild(a));
		},
		...
		exec: function (a, d, e) {
			...
			if (f)
				a.selection.executeAndRestore(function () {
					for (var a = f.length, b = 0, d, e, g; b < a; b++)
						(d = f[b]),
							(e = c.getParentElement(d, { nodeName: "code" })),
							(g = c.getTextContent(d)),
							g.match(c.autoLink.URL_REG_EXP) && !e ? c.renameElement(d, "code") : c.replaceWithChildNodes(d);
				});
			else {
				var d = (e = "object" === typeof e ? e : { href: e }),
					e = a.doc,
				...
				k = j;
				1 === h &&
					((h = c.getTextContent(j)),
					(i = !!j.querySelector("*")),
					(h = "" === h || h === b.INVISIBLE_SPACE),
					!i &&
						h &&
						(c.setTextContent(j, d.text || j.href),
						(d = e.createTextNode(" ")),
	...
	b.commands.formatBlock = {
		exec: function (h, i, g, j, k) {
			var m = h.doc,
				...
				u = v ? "DIV" : "P",
				p,
				g = "string" === typeof g ? g.toUpperCase() : g;
			if (n)
					...
					if (((p = h.selection.getSelectedNode()), (n = e.getParentElement(p, { nodeName: f })))) {
						h.selection.executeAndRestore(function () {
							...
							if (j) {
								var a = n;
								a.className
									? ((a.className = a.className.replace(k, "")), (a.className += " " + j))
									: (a.className = j);
							}
						});
						return;
				...
				if (h.commands.support(i)) {
					h = g || u;
					if (j)
						var r = e.observe(m, "DOMNodeInserted", function (a) {
							var a = a.target,
								c;
							a.nodeType === b.ELEMENT_NODE &&
								((c = e.getStyle("display").from(a)),
								"inline" !== c.substr(0, 6) && (a.className += " " + j));
						});
					m.execCommand(i, !1, h);
					r && r.stop();
				} else
					(n = m.createElement(g || u)),
						j && (n.className = j),
						(i = n),
						h.selection.selectLine(),
						h.selection.surround(i),
						(m = a(i)),
						(r = c(i)),
						m && "BR" === m.nodeName && m.parentNode.removeChild(m),
						r && "BR" === r.nodeName && r.parentNode.removeChild(r),
						(m = i.lastChild) && "BR" === m.nodeName && m.parentNode.removeChild(m),
		...
		state: function (a, b, c, d, f) {
			...
			return e.getParentElement(a, { nodeName: c, className: d, classRegExp: f });
		},
	};
})(wysihtml5);
(function (b) {
	...
	b.commands.formatInline = {
		...
		state: function (d, f, h, i, g) {
			var f = d.doc,
				j = a[h] || h;
			if (
				(!b.dom.hasElementWithTagName(f, h) && !b.dom.hasElementWithTagName(f, j)) ||
		...
		exec: function (c, a, d) {
			...
			if (a)
				...
				b.browser.hasProblemsSettingCaretAfterImg()
					? ((d = e.createTextNode(b.INVISIBLE_SPACE)), c.selection.insertNode(d), c.selection.setAfter(d))
	...
	b.commands.insertLineBreak = {
		exec: function (a, d) {
			a.commands.support(d)
				? (a.doc.execCommand(d, !1, null), b.browser.autoScrollsToCaret() || a.selection.scrollIntoView())
...
wysihtml5.commands.insertOrderedList = {
	exec: function (b, c) {
		var a = b.doc,
			...
			e = wysihtml5.dom.getParentElement(d, { nodeName: "OL" }),
			f = wysihtml5.dom.getParentElement(d, { nodeName: "UL" }),
			d = "_wysihtml5-temp-" + new Date().getTime(),
			h;
		!e && !f && b.commands.support(c)
			...
			: e
				...
				: f
					...
					: (b.commands.exec("formatBlock", "div", d),
						(h = a.querySelector("." + d)),
						(a = "" === h.innerHTML || h.innerHTML === wysihtml5.INVISIBLE_SPACE || "<br>" === h.innerHTML),
						b.selection.executeAndRestore(function () {
...
wysihtml5.commands.insertUnorderedList = {
	exec: function (b, c) {
		var a = b.doc,
			d = b.selection.getSelectedNode(),
			e = wysihtml5.dom.getParentElement(d, { nodeName: "UL" }),
			f = wysihtml5.dom.getParentElement(d, { nodeName: "OL" }),
			d = "_wysihtml5-temp-" + new Date().getTime(),
			h;
		!e && !f && b.commands.support(c)
			? a.execCommand(c, !1, null)
...
(function (b) {
	...
	b.UndoManager = b.lang.Dispatcher.extend({
				...
				d.observe(this.element, "contextmenu", function () {
					...
					i = setInterval(function () {
						f.getElementById("_wysihtml5-redo")
							? (j(), e.redo())
							: f.getElementById("_wysihtml5-undo") || (j(), e.undo());
					}, 400);
					g ||
						((g = !0),
						d.observe(document, "mousedown", j),
						d.observe(f, ["mousedown", "paste", "cut", "copy"], j));
				});
			}
			this.editor
		...
		transact: function () {
			var a = this.historyStr[this.position - 1],
		...
		set: function (a) {
			...
			for (var b = 0, c = a.childNodes, d = a.childNodes.length; b < d; b++)
				this.element.appendChild(c[b].cloneNode(!0));
			a.hasAttribute("data-wysihtml5-selection-offset")
				? ((b = a.getAttribute("data-wysihtml5-selection-offset")),
					(c = a.getAttribute("data-wysihtml5-selection-node")),
					(a = this.element))
				: ((a = this.element.querySelector("[data-wysihtml5-selection-offset]") || this.element),
					(b = a.getAttribute("data-wysihtml5-selection-offset")),
					(c = a.getAttribute("data-wysihtml5-selection-node")),
					a.removeAttribute("data-wysihtml5-selection-offset"),
					a.removeAttribute("data-wysihtml5-selection-node"));
...
(function (b) {
	...
	b.views.Composer = b.views.View.extend({
		...
		_create: function () {
			...
			(e =
				"string" === typeof this.config.placeholder
					...
					: this.textarea.element.getAttribute("placeholder")) && c.simulatePlaceholder(this.parent, this, e);
		...
		_initLineBreaking: function () {
			function d(a) {
				var b = c.getParentElement(a, { nodeName: ["P", "DIV"] }, 2);
				b &&
			...
			this.config.useLineBreaks ||
				c.observe(this.element, ["focus", "keydown"], function () {
					if (e.isEmpty()) {
						var b = e.doc.createElement("P");
						e.element.innerHTML = "";
						e.element.appendChild(b);
						a.displaysCaretInEmptyContentEditableCorrectly()
							? e.selection.selectNode(b, !0)
							: ((b.innerHTML = "<br>"), e.selection.setBefore(b.firstChild));
					}
				});
				...
				if (!a.shiftKey && !(g !== b.ENTER_KEY && g !== b.BACKSPACE_KEY)) {
					...
					j
						? setTimeout(function () {
								...
								if ("LI" === j.nodeName) {
									if (!a) return;
									(f = c.getParentElement(a, { nodeName: h }, 2)) || d(a);
								}
...
(function (b) {
	...
	b.views.Composer.prototype.style = function () {
		...
		if (
			(k.getAttribute("rows") && "auto" === c.getStyle("height").from(k)) ||
			(k.getAttribute("cols") && "auto" === c.getStyle("width").from(k))
		)
			k.style.display = p = v;
		...
		if (k.setActive)
			...
			var t = k.style,
				...
				t = { position: t.position, top: t.top, left: t.left, WebkitUserSelect: t.WebkitUserSelect };
...
(function (b) {
	...
	b.views.Composer.prototype.observe = function () {
		...
		a.hasHistoryIssue() &&
			a.supportsSelectionModify() &&
			c.observe(i, "keydown", function (a) {
				if (a.metaKey || a.ctrlKey) {
					var b = a.keyCode,
						c = i.ownerDocument.defaultView.getSelection();
					if (37 === b || 39 === b)
						37 === b && (c.modify("extend", "left", "lineboundary"), a.shiftKey || c.collapseToStart()),
							39 === b && (c.modify("extend", "right", "lineboundary"), a.shiftKey || c.collapseToEnd()),
							a.preventDefault();
				}
			});
		c.observe(i, "keydown", function (a) {
		...
		a.hasIframeFocusIssue() &&
			(c.observe(this.iframe, "focus", function () {
				setTimeout(function () {
	...
	b.views.Synchronizer = Base.extend({
		...
		_observe: function () {
			...
			this.editor.on("change_view", function (b) {
				"composer" === b && !c
					? (a.fromTextareaToComposer(!0), e())
					: "textarea" === b && (a.fromComposerToTextarea(!0), f());
			});
		...
		_interpolate: function (a) {
			for (
				var b,
					...
					h = this.container.querySelectorAll("[data-wysihtml5-dialog-field]"),
					i = h.length,
					g = 0;
				g < i;
				g++
				...
				(b = h[g]),
					b !== f &&
						...
						(c = this.elementToChange ? this.elementToChange[c] || "" : b.defaultValue),
						(b.value = c));
		},
		show: function (a) {
	...
	b.toolbar.Toolbar = Base.extend({
		...
		_getLinks: function (a) {
			for (
				...
				(i = c[f]),
					(j = i.getAttribute("data-wysihtml5-" + a)),
					(k = i.getAttribute("data-wysihtml5-" + a + "-value")),
					(g = this.container.querySelector("[data-wysihtml5-" + a + "-group='" + j + "']")),
					(m = this._getDialog(i, j)),
					(h[j + ":" + k] = { link: i, group: g, name: j, value: k, dialog: m, state: !1 });
		},
			...
			for (e in a)
				(h = a[e]),
					this.commandsDisabled
						? ((f = !1),
							c.removeClass(h.link, "wysihtml5-command-active"),
							h.group && c.removeClass(h.group, "wysihtml5-command-active"),
							h.dialog && h.dialog.hide())
						: ((f = this.composer.commands.state(h.name, h.value)),
							b.lang.object(f).isArray() && (f = 1 === f.length ? f[0] : !0),
							c.removeClass(h.link, "wysihtml5-command-disabled"),
							h.group && c.removeClass(h.group, "wysihtml5-command-disabled")),
					h.state !== f &&
						((h.state = f)
							? (c.addClass(h.link, "wysihtml5-command-active"),
								h.group && c.addClass(h.group, "wysihtml5-command-active"),
