	...
	RangePrototype.prototype = {
		...
		union: function (range) {
			if (this.intersectsRange(range, true)) {
				...
				if (
					dom.comparePoints(range.startContainer, range.startOffset, this.startContainer, this.startOffset) == -1
				) {
	...
	wysihtml5.views.Composer = wysihtml5.views.View.extend(
		/** @scope wysihtml5.views.Composer.prototype */ {
			...
			_create: function () {
				...
				dom.copyAttributes(["className", "spellcheck", "title", "lang", "dir", "accessKey"])
		...
		/** @scope wysihtml5.toolbar.Toolbar.prototype */ {
			...
			_getLinks: function (type) {
				var links = (this[type + "Links"] = wysihtml5.lang
						.array(this.container.querySelectorAll("a[data-wysihtml5-" + type + "]"))
						.get()),
					length = links.length,
					i = 0,
			...
			_initParser: function () {
				this.observe("paste:composer", function () {
					var keepScrollPosition = true,
						that = this;
					wysihtml5.selection.executeAndRestore(
						this.composer.sandbox.getDocument(),
						function () {
