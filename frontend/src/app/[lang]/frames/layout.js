...
//
// import FramesLayout from "@/layout/<route>"; // File import statement
...
export default async function FramesLayout({ children, params }) {
	...
	return (
		<>
			<div className="frames_layout grid_cont footer order-2 order-xl-0">{/* content */}</div>

			<div className="frames_layout grid_cont content order-1">{children}</div>
		</>
	);
}
