...
class Carousel extends BaseComponent {
	...
	_getItemIndex(e) {
		return (
			(this._items = e && e.parentNode ? SelectorEngine.find(SELECTOR_ITEM, e.parentNode) : []), this._items.indexOf(e)
		);
	}
	_getItemByOrder(e, t) {
...
class Modal extends BaseComponent {
	...
	hide(e) {
		if ((e && ["A", "AREA"].includes(e.target.tagName) && e.preventDefault(), !this._isShown || this._isTransitioning))
			return;
...
const uriAttrs = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
	...
	allowedAttribute = (e, t) => {
		...
		if (t.includes(n))
			return !uriAttrs.has(n) || Boolean(SAFE_URL_PATTERN.test(e.nodeValue) || DATA_URL_PATTERN.test(e.nodeValue));
...
class Tooltip extends BaseComponent {
	...
	setElementContent(e, t) {
		if (null !== e)
			return isElement(t)
				...
				: void (this._config.html
						? (this._config.sanitize && (t = sanitizeHtml(t, this._config.allowList, this._config.sanitizeFn)),
							(e.innerHTML = t))
						: (e.textContent = t));
	}
	getTitle() {
		...
		return (
			e || (e = "function" == typeof this._config.title ? this._config.title.call(this._element) : this._config.title),
			e
		);
	}
	updateAttachment(e) {
	...
	_setListeners() {
		this._config.trigger.split(" ").forEach((e) => {
			if ("click" === e)
				EventHandler.on(this._element, this.constructor.Event.CLICK, this._config.selector, (e) => this.toggle(e));
			else if ("manual" !== e) {
