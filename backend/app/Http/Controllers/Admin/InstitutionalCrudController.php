 ...
 */
class InstitutionalCrudController extends CrudController
{
	...
	{
		HelperBackend::setFieldsView(new \App\Models\Institutional());
	...
	{
		CRUD::setValidation(InstitutionalRequest::class);
		HelperBackend::setFields(new \App\Models\Institutional());
	...
	{
		HelperBackend::setFieldsShow(new \App\Models\Institutional());
	}
}
